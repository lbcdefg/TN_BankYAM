    ...
    <nav class="nav-main">
        <header class="nav-header">
            <div class="nav-header-1">
                <a href="index" title="메인 화면"><img src="img/YamLogo.png" class="nav-image"></a>
                <a href="index" title="메인 화면"><img src="img/YamLogoHover.png" class="nav-image-hover"></a>
            </div>
            <div class="nav-header-1">
            <ul class="nav-menu">
                <li class="nav-menu-item menu-show-full">
                    <a href="price.do" class="menu-dropdown">페이지</a>
                </li>
                <li class="nav-menu-item menu-show" id="nav-post">
                    <a href="#" class="menu-over500show">뱅킹</a>
                ...
                <li class="nav-menu-item menu-show" id="nav-post">
                    <a href="#" class="menu-over500show">얌톡</a>
                    <div class="nav-post-box">
                ...
                <li class="nav-menu-item menu-show-full">
                    <a href="introduce" class="menu-dropdown">뱅크얌</a>
                </li>
