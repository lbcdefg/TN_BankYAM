...
var action_popup = {
    ...
    close : function(target){
        ...
        }else if(modal.hasClass("type-prompt")){
            dimLayer = $(".dimLayer[target=type-prompt]");
            $(".type-prompt .btn_ok").unbind("click");
        }else{
...
$(function () {
    //사용 예시 **************************
    $(document).on("click", "#1111111111", function () {
